...
exports.SubscribersModule = SubscribersModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([subscription_entity_1.Subscription, user_entity_1.User, magazine_entity_1.Magazine])],
        controllers: [subscriptions_controller_1.SubscriptionController],
        providers: [subscriptions_service_1.SubscriptionService],
